...
$(window).on('beforeunload', function() {
  // Save any data or perform any actions before the page is refreshed (if needed)
});

// Add an event listener to capture the unload event (when the page is being unloaded, including refresh)
$(window).on('unload', function() {
  // This code will execute when the page is being unloaded (refreshed)

  // Here, you can perform any specific actions, like updating the content of a div
  updateSpecificDiv();
});

// Function to update the content of the specific div
function updateSpecificDiv() {
  // Replace the content with new content or fetch updated content from a server
  $('#myDiv').html('<p>Refreshed content goes here.</p>');
}
